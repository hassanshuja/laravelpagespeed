var br = "https://www.meinweekend.ch/", offerType = 'alle', offerRegion = 'alle', offerDuration = 'alle', keyw = 'alle', vaucherCustom = 100, activateEnter = !1, jssor1_slider = null, validator = null, scrollHistory = [];
...
$(document).ready(function () {
    ...
    $(document).on("click", "a", function (e) {
        var clicked = $(this);
        var gLClass = clicked.attr('class');
        if (!gLClass)
        {
            gLClass = ''
        }
...
function searchFilter()
{
    ...
    $.ajax({
        url: br + searchLink + '?navigate=1', type: "GET", headers: {
            'allowNavigate': 1}
        , context: document.body}
    ).done(function (r) {
        window.location.href = br + searchLink + "/";
        if (r.view)
        {
            $('#pageDynamic').html(r.view)
        }
