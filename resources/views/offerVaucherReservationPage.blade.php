{{-- {{dd($images)}} --}}
{{-- {{dd($vaucherData)}} --}}
<link rel="stylesheet" href="{{asset('css/offerVaucherPageV2.css')}}">
<link rel="stylesheet" href="{{asset('css/giftcard02.css')}}">
<link rel="stylesheet" href="{{asset('css/giftcard03.css')}}">
<style>
    .giftStep3Row p{
        ...
        <div class="row voucherImgForm ">
            ...
            <div class="col-12 col-sm-6 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <textarea onchange="br2nl(this)" maxlength="400" class="form-control vouchDescAr" name="vouchText" id="offerVaucherTextarea" rows="5">{!!strip_tags($di->list_subtitle, ''); !!}</textarea>
                </div>
