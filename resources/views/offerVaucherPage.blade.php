    ...
    font-weight: 700;"  href="https://www.meinweekend.ch/geschenkgutschein/">Wertgutschein</a>
        ...
        <div class="row voucherImgForm ">
            ...
            <div class="col-12 Title">
                <h1>{!!$d->title!!} als Erlebnisgutschein</h1>
            </div>
            @endforeach
            <div class="col-12 col-sm-6 col-md-6 vouchPart1">
                ...
                <div class="vouchHolder" style="text-align:center; width: 450px;display: inline-block;">
                    <img class="img-fluid" src="{{url('/assets/voucher/headlogo.PNG')}}" alt="headlogo">
                        <div id="onePhoto" style="display:none;" class="">
                            <img id="onePhotoSwitch" class="img-fluid"  style="width:100%;" src="{{url('assets/img'.$images[0]->image)}}" alt="Gutschein">
                        </div>
                                        ...
                                        @foreach($images as $key=>$i)
                                            <td>
                                                <div class="multiImageHld">
                                                    <img id='mainImage{{$key.$key.$key}}' class="img-fluid" src="{{url('assets/img'.$i->image)}}" alt="meinweekend Gutschein">
                                                </div>
                                            </td>
                                        @endforeach
                                    </tr>
                    ...
                    <div id="voucherDescArea">
                            {!! \App\Helpers\Helpers::clean_text($di->list_subtitle) !!}
                    </div>
                ...
                <div>
                            ...
                            <div class="thumbImg" onClick="showImageVoucherMultiple()">
                                <table class="table allImgs">
                                    <tbody>
                                        <tr>
                                            @foreach($images as $key=>$i)
                                                <td style="vertical-align:top !important;"><img id='mainImage{{$key}}'  class="img-fluid" src="{{url('assets/img'.$i->image)}}" alt="meinweekend Gutschein"></td>
                                            @endforeach                     
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <li>
                        <div class="thumbImg" onClick='showImageVoucherSingle("{{'assets/img'.$i->image}}",{{$pCount}})'>
                            <img class="img-fluid"  src="{{url('assets/img'.$i->image)}}" alt="meinweekend Gutschein">
                        </div>
                    </li>
            ...
            <div class="col-12 col-sm-6 col-md-6">
                ...
                <div class="priceDiv">
                    {!! \App\Helpers\Helpers::clean_text($prices) !!}
                </div>
                ...
                <div class="priceTotWarp">
                    ...
                    <h4>Gesamtbetrag</h4><h2>{{$data2['s_currency'] ==0 ? 'CHF':'EUR'}} <span id="bookingTotal">0</span><span>.00</span></h2><h5>{{$data2['s_currency']== 0 ? 'EUR':'CHF'}} <span id="shiftBookingTotal" >0</span>*</h5>
                </div>
                <div class="totalText">
                ...
                <div class="row checkBoxRow">
                    <div class="col-12">
                            <div class="checkRowAlign form-check" style="text-align: right;">
                                ...
                                <label style="font-size:13px;" class="form-check-label">ICH AKZEPTIERE DIE <a  href="{{URL('agb')}}">AGB</a> VON WWW.MEINWEEKEND.CH</label>
                            </div>
                    </div>
                </div>
        ...
        <script>
$(document).ready(function(){setOffer("{{$offer}}"),changeDetectorInput(),activateDate()});
        </script>
