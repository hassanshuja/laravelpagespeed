...
<div class="part1N2">
    <div id="bookingStep1" class="section1 bookingSteps stepShowBookingSpecial">
                        ...
                        <div class="slider1ContainerStyle" id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 780px; height: 300px;">
                            <style>
                                ...
                                <div class="slider1Style" data-u="slides" style="cursor: move; position: absolute; overflow: hidden; left: 0px; top: 0px; width: 780px; height: 300px;">
                                    ...
                                    <div>
                                        <img data-u="image" src="{{url('assets/img/'.ltrim($i->identifier, '/'))}}" alt="{{$i->title}}"/>
                                        @if($i->title !='')
                                            <div data-u="image" class="sliderImageDescription">
                                                    {{$i->title}}
                                            </div>
                                            @endif
                                                <img data-u="thumb" src="{{url('assets/img/'.ltrim($i->identifier, '/'))}}" alt="{{$i->title}}"/>
                                    </div>
                                    @endforeach
                                    </div>
        ...
        <style>
            ...
            <div data-u="arrowleft" class="jssora055 slider1ArrowStyleR" style="width:35px;height:35px;top:0px;left:0px;background: rgba(255, 255, 255, 0.8);" data-autocenter="2" data-scale="0.75" data-scale-left="0.75">
                <svg viewBox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
                    <polyline class="a" points="11040,1920 4960,8000 11040,14080 "></polyline>
                </svg>
            </div>
            <div data-u="arrowright" class="jssora055 slider1ArrowStyleL" style="width:35px;height:35px;top:0px;right:-1px;background: rgba(255, 255, 255, 0.8);" data-autocenter="2" data-scale="0.75" data-scale-right="0.75">
                <svg viewBox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
                                ...
                                <div class="carousel-inner">
                                    @foreach($allData['singleOfferData'][0]->images as $i)
                                        @if($loop->first)
                                            ...
                                            <img class="d-block w-100" src="../../assets/img/{{$i->identifier}}" alt="{{$i->identifier}}">
                                            </div>
                                        @else
                                ...
                                <ol class="carousel-indicators">
                                    @foreach($allData['singleOfferData'][0]->images as $i)
                                        <li data-target="#carouselExampleIndicators" data-slide-to="{{$loop->index}}" class="active">
                                            ...
                                            <img class="img-fluid" src="../../assets/img/{{$i->identifier}}" alt="{{$i->identifier}}">
                                            <div class="inactiveSlie"></div>

                                        </li>
                                    @endforeach
                                    {{-- <li data-target="#carouselExampleIndicators" data-slide-to="1"><img class="img-fluid" src="../../assets/images/home/fliegen.jpg" alt="First slide"><div class="inactiveSlie"></div></li>
                                    <li data-target="#carouselExampleIndicators" data-slide-to="2"><img class="img-fluid" src="../../assets/images/home/fliegen.jpg" alt="First slide"><div class="inactiveSlie"></div></li>
                                    <li data-target="#carouselExampleIndicators" data-slide-to="3"><img class="img-fluid" src="../../assets/images/home/fliegen.jpg" alt="First slide"><div class="inactiveSlie"></div></li>
                                    <li data-target="#carouselExampleIndicators" data-slide-to="4"><img class="img-fluid" src="../../assets/images/home/fliegen.jpg" alt="First slide"><div class="inactiveSlie"></div></li>
                                    <li data-target="#carouselExampleIndicators" data-slide-to="5"><img class="img-fluid" src="../../assets/images/home/fliegen.jpg" alt="First slide"><div class="inactiveSlie"></div></li>
                                    <li data-target="#carouselExampleIndicators" data-slide-to="6"><img class="img-fluid" src="../../assets/images/home/fliegen.jpg" alt="First slide"><div class="inactiveSlie"></div></li>
                                    <li data-target="#carouselExampleIndicators" data-slide-to="7"><img class="img-fluid" src="../../assets/images/home/fliegen.jpg" alt="First slide"><div class="inactiveSlie"></div></li> --}}
                                {{-- </ol> --}}
                              {{-- </div> --}}
                </div>
            </div>
            ...
            <div class="row infoHold">
                <div class="col-12 likeWarp">
                      ...
                      <div class="fb-like" data-href="{{url()->full()}}" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="false"></div>
                </div>
            ...
            <div class="row">
              ...
              <div class="">
                  <script>
                      ...
                      //var stTime=new date("{{$od->starttime}}"),endTime=new date("{{$od->starttime}}");
// $(document).ready(function () {
...
//     });
                ...
                <textarea id="availableDays">
                  ...
                  <a  href="{{url('angebote/geschenkgutschein-geschenkidee/ideen/'.$offerUrl)}}/" >
                    <img src="{{url('images/gutschein.svg')}}" class="img-fluid">
                  </a>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 mapHold nopadding">
                    ...
                    @endphp
                    <div id="gMap1">
                        {{-- <iframe src="{{url('https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d3736489.7218514383!2d90.21589792292741!3d23.857125486636733!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1506502314230')}}" width="100%" height="315" frameborder="0" style="border:0" allowfullscreen></iframe> --}}
                    ...
                    <div id="hiddeAdditionalOff">
                        ...
                        <div class="additionalBorder" id="inLinks1">
                            ...
                            <div class="relLinkImgHld">
                                <img class="img-fluid" src="{{url('assets/img/'.ltrim($rl->related_offer_image, '/'))}}">
                            </div>
                                <br>
...
$(document).ready(function () {
    ...
    setTimeout(function(){
        ...
        iframe.src = "https://www.google.com/maps/embed/v1/search?key=AIzaSyBtsfn9ubhZMOMsR-vwbeJXLu4pMjSLgLU&q={{$address}}";
        iframe.width ="100%";
        iframe.height ="315";
    ...
    if (d.getElementById(id)) return;
    js = d.createElement(s); js.id = id;
    js.src = 'https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v3.0&appId=709045449283674&autoLogAppEvents=1';
    fjs.parentNode.insertBefore(js, fjs);
