          ...
          <div class="col-12 col-sm-6 col-md-6 vouchPart1">
            ...
            <div class="giftImgHolder">
              <div class="vouchHolder" style="text-align:center;">
                ...
                <img id='mainImage' class="img-fluid" src="{{url('assets/voucher/'.$vauchers[0]->image)}}">
              ...
              <div>
                {{-- <ul>
                  <li>
                    <div class="thumbImg">
                      <img class="img-fluid" onClick='showImage("giftImage.png")' src="{{url('images/giftImage.png')}}">
                    </div>
                  </li>
                  <li>
                    <div class="thumbImg">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <img class="img-fluid"  src="{{url('assets/voucher/'.$d->image)}}">
                    </div>
                  </li>
