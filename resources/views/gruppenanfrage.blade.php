...
<link rel="stylesheet" href="{{url('css/gruppenanfrage.css')}}">      
    ...
    <div class="col-7 gruppenanfrageForm">
        ...
        <form id="groupOfferForm">
            ...
            <div class="form-row row">
                ...
                <div class="col-10">
                    <input type="text" id="excursion_package" name="excursion_package" class="form-control" value="{{$offerName}}" placeholder="{{$offerName}}">
                </div>
            </div>
            <div class="form-row row">
                <label class="col-2 col-form-label">Gewünschtes Datum</label>
                <div class="col-10">
                <input type="date" id="group_date" name="group_date" class="form-control" placeholder="Datum" value="{{$date}}">
                </div>
            </div>    
            <div class="form-row row">
