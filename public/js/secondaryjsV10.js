...
function selectPricesOfferVaucher(d,offVauchUrl){
    ...
    $.ajax({
        ...
        .done(function( msg ) {
            if(msg)
            {
                navigateMaster('offerVaucherReservation/'+offVauchUrl+'?navigate=1&step=2',{manualPushState:"angebote/geschenkgutschein-geschenkidee/ideen/"+offVauchUrl+"?step=1"});
                // offerVaucherReservation
