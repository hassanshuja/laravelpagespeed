...
$(document).ready(function () {
    ...
    $( document ).on('click',"#voucherStepb1,#voucherStepb2,#voucherStepb2Pay,#voucherStepb3", function(eve) {
      ...
      $( document ).on('click',"#voucherOffers2,#voucherOffers3,#voucherOffers3Pay,#voucherOffers4", function(eve) {
        ...
        {
            var vFor=$('#vouchName').val();
            //var vText=$('#offerVaucherTextarea').val().replace(/\n/g, "<br />");;
...
function submitVaucherStSecond(submitData){
    ...
    $.ajax({
        ...
        .done(function( msg ) {
            $('.loadingStepStyle').removeClass('forcedFlexNone');
            console.log(msg);
            // var mvfs1=$('#voucherStep3Confirm').html();
            // var pData={
            //     step:3,
            //     imgForm:mvfs1
            // };
...
function submitOfferVaucherTablePay(submitData){
    ...
    $.ajax({
        ...
        url: br+"submitOfferVaucherTablePay",
        data: submitData
      })
        .done(function( msg ) {
    ...
    $.ajax({
        ...
        error: function (jqXHR, exception) {
          ...
          if(!opt.backPressed)
          {
            ...
            //   {
            //     console.log('secRpushUrlFin 1',secRpushUrlFin);
            //     secRpushUrlFin=secRpushUrlFin.replace(/^\/|\/$/g, '');
            //     console.log('secRpushUrlFin 2',secRpushUrlFin);
            //     //secRpushUrlFin=secRpushUrlFin+'/';
            //     //console.log('secRpushUrlFin 3',secRpushUrlFin);
            //     }
            //     else
            //     {
            //         secRpushUrlFin=secRpushUrlFin.replace(/^\/|\/$/g, '/');
            ...
            //secRpushUrlFin=secRpushUrlFin.replace('//','/');
