<head>
    ...
    <?php echo $__env->make('metaDataView', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php if(strpos($_SERVER['REQUEST_URI'], "admin/") !== false): ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/bootstrap-datepicker1.7.1.min.css')); ?>">
<?php endif; ?>   
<link rel="stylesheet" href="<?php echo e(asset('css/all-pages.css').'?id2='.rand(1,200)); ?>">
<script async defer src="<?php echo e(asset('js/front.js').'?id2=2.02'); ?>"></script>
