          ...
          <div class="col-12 col-sm-6 col-md-6 vouchPart1">
            ...
            <div class="giftImgHolder">
              <div class="vouchHolder" style="text-align:center;">
                    <img class="img-fluid" src="<?php echo e(url('/assets/voucher/headlogo.PNG')); ?>" alt="Wertgutschein bestellen">
                <img id='mainImage' class="img-fluid" src="<?php echo e(url('assets/voucher/'.$vauchers[0]->image)); ?>" alt="Wertgutschein bestellen">
              ...
              <div>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <img class="img-fluid"  src="<?php echo e(url('assets/voucher/'.$d->image)); ?>" alt="Wertgutschein bestellen">
                    </div>
                  </li>
                  ...
                  <div class="buttonSuc">
                    ...
                    //     $myIp=get_client_ip();
                      ...
                      <?php if($myIp=="46.99.187.82"): ?>
                        <button type="submit" id="voucherStepb2Pay" class="btn btn-lg" style="display:none;"><?php echo e($myIp); ?> onlinesss payment</button>
                      <?php endif; ?>
                    </div>
              </div>
          </div>
