...
<link rel="stylesheet" href="<?php echo e(url('css/geschenkgutschein.css')); ?>">
<link rel="stylesheet" href="<?php echo e(url('css/giftcard02.css')); ?>">
<link rel="stylesheet" href="<?php echo e(url('css/giftcard03.css')); ?>">
<div class="container-fluid">
    ...
    <?php echo $__env->make('navoverview4', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      ...
      <div class="container-fluid voucherSteps <?php echo e($stInd==1 || $stInd=='' ? 'stepShowVoucher':''); ?>" id="voucherStep1">
        <div class="row giftCard">
          ...
          <div class="col-12 col-sm-12 col-md-6 hiddeMobileT2">
            <div class="topGeichHld">
                ...
                <p class="">Ein Geschenkgutschein ist eine tolle Geschenkidee zum Geburtstag, zum Jubiläum, zu Weihnachten, zur Hochzeit oder als Hauptgewinn an einem Wettbewerb.</p>
                <p class="">www.meinweekend.ch bietet Ihnen eine breite Auswahl für ein spannendes Weekend oder einen Tagesausflug in der Schweiz. Für Freizeit-Aktivisten und Romantiker – einfach für alle Menschen, die in ihrer Freizeit einmal etwas ganz Besonderes erleben möchten.</p>
                </div>
            </div>
          </div>
        ...
        <div class="row voucherImgForm ">
          ...
          <div class="col-12 col-sm-6 col-md-6 vouchPart1">
            ...
            <div class="giftImgHolder">
              <div class="vouchHolder" style="text-align:center;">
                    <img class="img-fluid" src="<?php echo e(url('/assets/voucher/headlogo.PNG')); ?>">
                <img id='mainImage' class="img-fluid" src="<?php echo e(url('assets/voucher/'.$vauchers[0]->image)); ?>">
              ...
              <div>
                ...
                <ul>
                    <?php
                     $vCount=0;
                    ?>
                    <?php $__currentLoopData = $vauchers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li>
                    <div class="thumbImg" onClick='showImage("<?php echo e('assets/voucher/'.$d->image); ?>",<?php echo e($vCount); ?>)'>
                    <img class="img-fluid"  src="<?php echo e(url('assets/voucher/'.$d->image)); ?>">
                    </div>
                  </li>
          ...
          <div class="col-12 col-sm-6 col-md-6">
            ...
            <div id="mainVaucherFormS1">
                    <?php if(Session::has('mainVaucherFormVaucher')): ?>
                    <?php echo Session::get('mainVaucherFormVaucher'); ?>
		  ...
		  <input type="hidden" id="voucherType" value="0"/>
              ...
              <div class="form-group row">
                <label for="example-date-input" class="col-12 col-md-2 col-lg-2 col-form-label">Gültig ab *</label>
                <div class="col-12">
                  <input id="user_validFrom" class="form-control" type="date" min="" name="vouchDate" id="example-date-input">
                </div>
              </div>
          ...
          <div class="col-12 submitButton">
            <div class="submitVoucher weiter-btn">
                    ...
                    <div class="loadingStepStyle" >
                            <img src="<?php echo e(url('loading.gif')); ?>"/>
                        </div>
      ...
      <form id="VouchForm2">
      <div id="voucherStep2" class="container-fluid voucherSteps <?php echo e($stInd==2 ? 'stepShowVoucher':''); ?>">
        <div id="voucherMainTableTop" class="row giftStep2Row">
            <?php if(Session::has('st2Price')): ?>
                <?php echo Session::get('st2Price'); ?>
              ...
              <div class="col-12">
                  <div class="table-responsive">
                      <table class="table">
                          <tbody>
                                <tr>
                                    <td colspan="5"><b class="blackNbold" style="color:black;">IHR WERTGUTSCHEIN</b></td>
                                    <td>
                                        <br>&nbsp;</td>
                                </tr>

                              <tr>
                                  <td class="tdSizeE" style="width:200px;"   colspan="4">
                                      Ausgestellt auf: 
                                  </td>
                                  <td>
          ...
          <?php if(Session::has('mainVaucherStep2')): ?>
          <?php echo Session::get('mainVaucherStep2'); ?>
         ...
         <?php else: ?>
                ...
                <div class="topGeichHld">
                  <h6 class="formTitle">RECHNUNGSADRESSE</h6>
                      ...
                      <div class="form-row row">
                          ...
                          <div class="col-12 col-md-10 col-lg-10">
                              <select class="formClassGes form-control" style="padding: 0px;" class="form-control" id="user_country" name="user_country">
          ...
          <div class="row checkBoxRow">
              <div class="col-12">
                      <div class="checkBoxStyle" style="text-align: right;" class="form-check">
          ...
          <div class="row button">
              <div class="col-12">
                  ...
                  <div class="buttonSuc">
                      ...
                      <button type="submit" id="voucherStepb2Pay" class="btn btn-lg" style="display:none;">Online Zahlung</button>
                      <?php
                      $myIp='';
                    //   function get_client_ip() {
                    //         $ipaddress = '';
      ...
      <div id="voucherStep3" class="container-fluid voucherSteps <?php echo e($stInd==3 ? 'stepShowVoucher':''); ?>">
            
            <div class="row stepsHold justify-content-center" id="vaucherLastStepTop">
        <?php if(Session::has('st3Price')): ?>
                <?php echo Session::get('st3Price'); ?>
      ...
      <?php if(Session::has('mainVaucherStep3')): ?>
            <?php echo Session::get('mainVaucherStep3'); ?>
