        ...
        <div class="vouchHolder" style="text-align:center;">
            <div class="voucherHeader">
                ...
                <div class="voucherHeaderContext">
                  <p style="color:#910b0b;font-size:16px;margin-right:30px">GUTSCHEIN - NR.<?php echo e(\Carbon\Carbon::createFromTimeStamp($d->v_cdate)->format('y')); ?>-<?php echo e($d->vid); ?>-W</p> 
                </div>
            </div>
            <img id='mainImage' class="img-fluid" src="/var/www/meinweekend.ch/html/public/assets/voucher/<?php echo e($d->image); ?>">
            <div class="voucherInfo">
                <h4 id="vouchNameTag">Für<br/><?php echo e($d->vaucher_for); ?></h4>
                ...
                <div class="priceNdate" style='border-top:1px solid #50617b;border-bottom:1px solid #50617b;margin-top:14px;'>
                    <div style='height:34px;margin-top:5px;position: relative;' >
                        <h6 style="float:left;color:#1e2228;">Wert:<span id="vouchPrice" style='color:#910b0b'> CHF <?php echo e($d->total_price); ?></span></h6><h6 style="float:right;">Gültig ab: <span id="vouchDate" style='color:#910b0b'> <?php echo date("d.m.Y",strtotime($d->valid_from))?></span></h6>
                    </div>
                </div>
