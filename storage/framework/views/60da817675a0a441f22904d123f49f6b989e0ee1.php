...
<html lang="en">
  <head>
    ...
    <title><?php echo e($data[0]->offer_title); ?>-Vaucher</title>
  </head>
  <body>
...
<style>
    ...
    @font-face {
        ...
        <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="noPaddingTB">
                                            ...
                                            <p>CH-<?php echo e($d->zip); ?> <?php echo e($d->city); ?></p>
                                            <br>
                                            <br>
                                            <br>
                                        </td>
                ...
                <tr>
                    <td class="tablE4">
                        <h5 class="resCapt"><?php echo e(strtoupper($d->offer_titleV)); ?></h5>
                        <?php echo $d->price_table; ?>
