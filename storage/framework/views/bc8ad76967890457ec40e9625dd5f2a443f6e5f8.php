...
<html lang="en">
  <head>
    ...
    <title><?php echo e($allData[0]->offer_title); ?>-Vaucher</title>
  </head>
  <body>
...
<style>
    ...
    @font-face {
        ...
        <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="noPaddingTB">
                                            ...
                                            <p><?php echo e($d->gender == '1' ? "Frau" : "Herr"); ?></p>
                                            <p><?php echo e($d->name); ?></p>
                                            <?php if(isset($d->company)): ?>
                                                <?php if($d->company!=''): ?>
                                                    <p><?php echo e($d->company); ?></p>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                            <p><?php echo e($d->address); ?></p>
                                            <p><?php echo e($d->country == 41 ? "CH": ($d->country == 54 ? "DE" : ($d->country == 13 ? "A": ""))); ?> <?php echo e($d->zip); ?> <?php echo e($d->city); ?></p>
                                            <br>
                                            <p>Telefon: <?php echo e($d->telephone); ?></p>
                                            <p>E-mail: <?php echo e($d->email); ?></p>
                                        </td>
                                    </tr>
                                    <tr><td></td></tr>
                                    <tr>
                                        ...
                                        <td class="contactInfo">
                                            Datum <?php echo e(\Carbon\Carbon::createFromTimeStamp($d->created_at)->format('d.m.Y')); ?> /kw
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <tr>
                    <td class="tablE4P1">
                        <h6>Reservations-Bestätigung: <?php echo e($d->confirmation_id); ?></h6>
                        <br>
                        
                        <p><?php echo e($d->gender == '1' ? "Liebe" : "Lieber"); ?> <?php echo e($d->gender == '1' ? "Frau" : "Herr"); ?> <?php echo e($d->last_name); ?></p>
                        <br>
                        <p><?php echo \App\Helpers\Helpers::clean_text($d->confirmation_intro); ?></p>
                    </td>
                </tr>
                <tr>
                    <td class="tablE4">
                        <h5 class="resCapt"><?php echo e(strtoupper($d->offer_title)); ?></h5>
                        <br>
                        <?php echo $d->confirmation_table; ?>
                            ...
                            <tr>
                                <td class="tablE5">
                                    <div>
                                        ...
                                        <?php echo $d->confirmation_services; ?>

                                    </div>
                                </td>
                                <td class="tablE6" style='vertical-align:top'>
                                    <div class="confCondWarp">
                                        <?php if($d->created_at <= 1527536990): ?>
                                            <?php echo \App\Helpers\Helpers::clean_text($d->confirmation_conditions); ?>

                                        <?php else: ?>
                                            <?php echo nl2br($d->confirmation_conditions); ?>
