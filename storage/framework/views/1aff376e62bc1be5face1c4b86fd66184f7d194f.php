        ...
        <div class="row">
            <div class="col-12">
                <div class="vaucherMainTop">
                    ...
                    <span>GUTSCHEIN - NR. <?php echo e(\Carbon\Carbon::createFromTimeStamp($d->v_cdate)->format('y')); ?>-<?php echo e($d->vid); ?>-S</span>
                    </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="vouchHolder" style="text-align:center;">
                    ...
                    <tbody>
                        <tr>
                            <td scope="col">
                                ...
                                <img id='soloImg' class="img-fluid" src="/var/www/meinweekend.ch/html/public/assets/img/<?php echo e($images[0]->image); ?>">
                                </div>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div id="multiplePhoto" class="imagesWarper">
                <table class="table" style='width:100%'>
                    <tbody>
                        <tr>
                            <td scope="col"><img id='mainImage' class="img-fluid" src="/var/www/meinweekend.ch/html/public/assets/img/<?php echo e($images[0]->image); ?>"></td>
                            <td scope="col"><img id='mainImage' class="img-fluid" src="/var/www/meinweekend.ch/html/public/assets/img/<?php echo e($images[1]->image); ?>"></td>
                            <td scope="col"><img id='mainImage' class="img-fluid" src="/var/www/meinweekend.ch/html/public/assets/img/<?php echo e($images[2]->image); ?>"></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="voucherInfo">
                <div class="vaucherTop arialsF">
                    <h1 style="font-size:22px;"><?php echo e(strtoupper($d->offer_title)); ?></h1>
                    <h2 id="vouchNameTag" class="vouchNameTag arialsF" style="padding-top:10px;"><?php echo e($d->vaucher_for); ?></h2>
                </div>
    ...
    <footer class="footer">
            <div class="container">
                    <div class="voucherFooter">
                            ...
                            <br>
                            <p style="color:#013a89"><b>Die Preisgarantie ist 1 Jahr ab Ausstellungsdatum <?php echo e(strftime("%d.%m.%Y", strtotime($d->valid_from))); ?>.</b><br>
