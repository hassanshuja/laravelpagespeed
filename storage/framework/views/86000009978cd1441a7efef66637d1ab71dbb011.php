       ...
       <p>Wir hoffen, Ihnen damit dienen zu können und stehen für Fragen gerne zur Verfügung.</p> 
        <?php elseif($request->send_type=='print@home'): ?>
            <p>Herzlichen Dank für Ihre Gutscheinbestellung.</p>
            <p>Gerne senden wir Ihnen den Wertgutschein (<?php echo e($data[0]->total_currency==0?"CHF":"EUR"); ?> <?php echo e($data[0]->total_price); ?>) von MeinWeekend.ch zusammen mit der Rechnung in der Beilage.
