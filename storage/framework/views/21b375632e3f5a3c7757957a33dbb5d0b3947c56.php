...
<link rel="stylesheet" href="<?php echo e(asset('css/offerVaucherPageV2.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('css/giftcard02.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('css/giftcard03.css')); ?>">
<style>
    .giftStep3Row p{
    ...
    <div id="bookingVouchers1" class="container-fluid contDefCss bookingSteps bookingInvalid <?php echo e($stInd==1 || $stInd=='' ? 'stepShowBooking':''); ?>">
        ...
        <div class="row hiddeMobileT2">
            ...
            <div class="col-12 col-md-6 col-lg-6 info2Warp">
                <div class="titleButton2">
                    <a  href="<?php echo e(URL('geschenkgutschein')); ?>"><button type="button" class="btn" >Wertgutschein</button><a>
                </div>
            </div>
        </div>
        ...
        <div class="row voucherImgForm ">
            ...
            <div class="col-12 Title">
                <h1 class=""><?php echo $d->title; ?> als Erlebnisgutschein bestellen</h1>
            </div>
                ...
                <div class="vouchHolder" style="text-align:center; width: 450px;display: inline-block;">
                    <img class="img-fluid" src="<?php echo e(url('/assets/voucher/headlogo.PNG')); ?>">
                        <div id="onePhoto" style="display:none;" class="">
                            <img id="onePhotoSwitch" class="img-fluid"  style="width:100%;" src="<?php echo e(url('assets/img/'.$images[0]->image)); ?>">
                        </div>
                                        ...
                                        <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td scope="col">
                                                <div class="multiImageHld">
                                                    <img id='mainImage' class="img-fluid" src="<?php echo e(url('assets/img/'.$i->image)); ?>">
                                                </div>
                                            </td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tr>
                    ...
                    <?php $__currentLoopData = $vaucherData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $od): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                        
                        <div class="offerInfo1">
                            <div class="offersIncluded1">
                                <?php echo $od->included; ?>

                            </div>
                        </div>
                        <div class="offerInfo2">
                            <?php echo $od->informacion; ?>
                ...
                <div>
                            ...
                            <div class="thumbImg" onClick="showImageVoucherMultiple()">
                                <table class="table allImgs" on>
                                    <tbody>
                                        <tr>
                                            <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <td scope="col" style="vertical-align:top !important;"><img id='mainImage'  class="img-fluid" src="<?php echo e(url('assets/img/'.$i->image)); ?>"></td>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                     
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <li>
                        <div class="thumbImg" onClick='showImageVoucherSingle("<?php echo e('assets/img'.$i->image); ?>",<?php echo e($pCount); ?>)'>
                            <img class="img-fluid"  src="<?php echo e(url('assets/img'.$i->image)); ?>">
                        </div>
                    </li>
            ...
            <div class="col-12 col-sm-6 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <textarea onchange="br2nl(this)" maxlength="400" class="form-control vouchDescAr" name="vouchText" id="offerVaucherTextarea" rows="5"><?php echo strip_tags($di->list_subtitle, '');; ?></textarea>
                </div>
                ...
                <div class="priceTotWarp">
                    ...
                    <h4>Gesamtbetrag</h4><h2><?php echo e($data2['s_currency'] ==0 ? 'CHF':'EUR'); ?> <span id="bookingTotal" style="price-total">0</span><span>.00</span></h2><h5><?php echo e($data2['s_currency']== 0 ? 'EUR':'CHF'); ?> <span id="shiftBookingTotal" style="price-total">0</span>*</h5>
                </div>
                <div class="totalText">
                ...
                <div class="row checkBoxRow">
                    <div class="col-12">
                            <div class="checkRowAlign" style="text-align: right;" class="form-check">
                                ...
                                <label style="font-size:13px;" class="form-check-label" for="exampleCheck1">ICH AKZEPTIERE DIE <a  href="<?php echo e(URL('agb')); ?>">AGB</a> VON WWW.MEINWEEKEND.CH</label>
                            </div>
                    </div>
                </div>
                <div class="row button">
                    <div class="col-12">
                        ...
                        <div class="loadingStepStyle" >
                            ...
                            <button type="submit" id="voucherOffers3Pay" class="btn btn-lg" style="display:none;">Online Zahlung</button>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <div id="bookingVouchers3" class="container-fluid bookingInvalid bookingSteps <?php echo e($stInd==3 || $stInd==4 ? 'stepShowBooking':''); ?>">
                ...
                <div class="row offerVauchStep22">
                    ...
                    <div class="colwithColorMarg col-12" style="margin-top:20px;color:#626262;" class="col-12">
            ...
            <div class="container-fluid bookingInvalid">
                <div class="row">
                    <div class="col-12" id="bookingVouchers5">
                    </div>
                </div>
            </div>
        <script>
